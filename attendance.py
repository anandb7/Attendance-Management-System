...
class Attendance:
    def __init__(self, root):
        ...
        attendanceId_entry=Entry(left_inner_frame,width=20,textvariable=self.var_attendance_id,font=("times new roman",12,"bold"),bg="white")
        ...
        rollno_entry=Entry(left_inner_frame,width=20,textvariable=self.var_rollno,font=("times new roman",12,"bold"),bg="white")
        ...
        name_entry=Entry(left_inner_frame,width=20,textvariable=self.var_name,font=("times new roman",12,"bold"),bg="white")
        ...
        dep_entry=Entry(left_inner_frame,width=20,textvariable=self.var_department,font=("times new roman",12,"bold"),bg="white")
        ...
        time_entry=Entry(left_inner_frame,width=20,textvariable=self.var_time,font=("times new roman",12,"bold"),bg="white")
        ...
        date_entry=Entry(left_inner_frame,width=20,textvariable=self.var_date,font=("times new roman",12,"bold"),bg="white")
        ...
        self.atten_status=ttk.Combobox(left_inner_frame,width=20,textvariable=self.var_attendance_status,font="comicsans 11 bold",state="readonly")
        ...
        Exportcsv_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=18,font=("times new roman",12,"bold"),bg="blue",fg="white")
