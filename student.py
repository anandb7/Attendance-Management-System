...
class Student:
    def __init__(self, root):
        ...
        studentName_entry=Entry(class_student_frame,textvariable=self.var_std_name,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        #class_div_entry=Entry(class_student_frame,textvariable=self.var_div,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        roll_no_entry=Entry(class_student_frame,textvariable=self.var_roll,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        dob_entry=Entry(class_student_frame,textvariable=self.var_dob,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        email_entry=Entry(class_student_frame,textvariable=self.var_email,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        phone_entry=Entry(class_student_frame,textvariable=self.var_phone,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        address_entry=Entry(class_student_frame,textvariable=self.var_address,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        teacher_entry=Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",12,"bold"),bg="white")
        ...
        btn_frame.place(x=0,y=160,width=700,height=35)

        save_btn=Button(btn_frame,text="Save",width=18,command=self.add_data,font=("times new roman",12,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",width=18,font=("times new roman",12,"bold"),bg="blue",fg="white",command=self.update_data)
        ...
        btn_frame1.place(x=0,y=195,width=700,height=35)

        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=39,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"D:\facial recognition system\images\1.webp")
        img_right = img_right.resize((720, 130), Image.ADAPTIVE)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        label3 = Label(Right_frame, image=self.photoimg_right)
        label3.place(x=5, y=0, width=720, height=130)
...
#--------------------FUNCTIONS-----------------------------
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="ind@1240",database="face_recognizer")
                cursor=conn.cursor()
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Student data has been stored successfully",parent=self.root)    
            ...
            if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
                ...
                try:
                    ...
                    if Update>0:
                        ...
                        if not Update:
                            return
                    messagebox.showinfo("Success","Details updates successfully")
                    conn.commit()
                    self.fetch_data()
                    conn.close()
                except Exception as es:
